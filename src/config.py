...
class Settings(BaseSettings):
    ...
    # Celery configuration (using filesystem broker and file backend)
    ...
    celery_result_folder: str = "./celery_results"
...
# Ensure Celery broker and result directories exist
...
os.makedirs(settings.celery_result_folder, exist_ok=True)